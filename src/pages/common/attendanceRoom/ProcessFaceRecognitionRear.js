                        ...
                        <>
                            ...
                            >
                                <Webcam
                                    ...
                                    //         ? { exact: selectedWebcam }
                                    //         : { exact: inputDevices.inputDevice.find(device => device.label.includes("rear")).deviceId },
                                    // }}

                                    // videoConstraints={{
                                    //     deviceId: selectedWebcam && selectedWebcam.deviceId
                                    //         ? { exact: selectedWebcam.deviceId }
                                    //         : { exact: inputDevices.inputDevice[0].deviceId },
                                    // }}
                                    videoConstraints={{
                                        deviceId: selectedWebcam,
                                    }}

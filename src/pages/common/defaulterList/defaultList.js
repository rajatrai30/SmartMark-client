...
export default (props) => {
  ...
  const titleList = [{ name: "Defaulter List", link: "/defaulterList" }];
  ...
  const handleAccess = (defaultlist) => {
    props.history.push(`/defaultlist/${defaultlist.shortID}`);
  };
    ...
    <Layout className="dashboard layout">
      ...
      <Layout>
        ...
        <Card>
          <Title
            level={4}
          >{`Select the Course to get Defaulter List`}</Title>
